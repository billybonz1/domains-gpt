...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  data: function data() {
    return {
      text: 'Пример текста с @упоминаниями и @тегами'
    };
  },
  methods: {
    highlightText: function highlightText(text) {
      // Регулярное выражение для поиска слов, начинающихся с символа "@"
      var regex = /(^|\s)(@\w+)/g;

      // Заменяем слова, начинающиеся с "@", на подсвеченные красным
      var highlightedText = text.replace(regex, '$1<span class="highlight">$2</span>');
...
var render = function () {
  ...
  return _c("div", [
    _c("p", { domProps: { innerHTML: _vm._s(_vm.highlightText(_vm.text)) } }),
  ])
}
var staticRenderFns = []
