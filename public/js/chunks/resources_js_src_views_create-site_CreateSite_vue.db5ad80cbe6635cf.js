...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    showEditDialog: function showEditDialog(index) {
      this.$set(this.showEditModal, index, true);
    },
    hideEditDialog: function hideEditDialog(index) {
      this.$set(this.showEditModal, index, false);
    },
    changeSubmit: function changeSubmit(e) {
      // Обработчик изменений, если требуется
    },
    deleteItem: function deleteItem(index) {
      // Обработчик удаления элемента, если требуется
    }
  },
  created: function created() {
    this.showEditModal = new Array(this.items.length).fill(false);
  }
});
