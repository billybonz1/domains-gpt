...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-codemirror'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    VueCodemirror: Object(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-codemirror'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  },
  data: function data() {
    return {
      code: '// Type some JavaScript code here',
      options: {
        mode: 'javascript',
        theme: 'material',
        lineNumbers: true
