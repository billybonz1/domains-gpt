...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    highlightHTML: function highlightHTML() {
      ...
      var valuesRegex = /"([^"]*)"/g;
      var highlightedHTML = html.replace(tagsRegex, '<span class="tag">$1$2</span>').replace(attributesRegex, '<span class="attribute">$1$2</span>').replace(valuesRegex, '<span class="value">"$1"</span>');
    ...
    highlightCSS: function highlightCSS() {
      ...
      var valuesRegex = /(:\s*)([^;]+)/g;
      var highlightedCSS = css.replace(selectorsRegex, '<span class="selector">$1</span>').replace(propertiesRegex, '<span class="property">$1</span>').replace(valuesRegex, '$1<span class="value">$2</span>');
